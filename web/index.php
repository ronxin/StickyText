...
<h3> Xin Rong, 04/2013<br />
<a href="mailto:ronxin@umich.edu">ronxin@umich.edu</a><br />
...
<?php
	...
	if($strin != ""){
	    exec("python /Users/ronxin/StickyText/src/stickytest.py ".$temp_file." ".$metric." ".$scale." ".$good." ".$bad, $ret);
